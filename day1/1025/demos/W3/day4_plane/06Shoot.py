...
from demos.W3.day4_plane.Hero import Hero, Bullet
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if count % 10 == 0:
            ...
            # 装载一颗子弹
            b = bulletList[bulletIndex]
            bulletSound.play()# 呼啸
            b.isAlive = True

            # 从机头飞出
            bulletIndex = (bulletIndex+1) % 10
            b.rect.left = hero.rect.midtop[0] - b.rect.width//2
            b.rect.top = hero.rect.midtop[1] - b.rect.height
            # winSurface.blit(b.surface,(bLeft,bTop))

        # 绘制所有活着的子弹
        # 让所有活着的子弹飞
        for b in bulletList:
            if b.isAlive:
                winSurface.blit(b.surface, (b.rect.left,b.rect.top))
                b.move()
